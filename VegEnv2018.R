#This is a merger of data Emily produced in Jan 2018 as shown in 2 following files:
#"HydrologicDataECF.R" and ""VegECF.R"
library(tidyverse)
library(vegan)

#JOIN VEG6 with ENVC4 to produce DATA=====
...
freshEnv<-freshOnly_Cover [ , c(1:7,286, 438:451)] # Env data for Freshwater Community +"Phraust"
...
plot(fresh_rda, display=c("lc","cn"), main="Lousiana Freshwhater Communities (2007-2016)")
...
ggsave('2018Freshwater_RDA_Plot4.jpeg', dpi=300, height=5, width=9)
...
dim(IntermediateOnly)#767 441
unique(IntermediateOnly$year)#Lack of 2007.
...
dim(IntermediateOnly_Cover)#714 441

IntermediateVeg_Cover<-IntermediateOnly_Cover[,8:437] #Intermediatewater veg cover data only
...
IntermediateEnv<-IntermediateOnly_Cover [ , c(1:7,286, 438:441)] # Env data for Intermediatewater Community +"Phraust"
dim(IntermediateEnv)#714  12, colum 286 = "Phraaust"
...
# PLOTS (quick ones to see)
plot(Intermediate_rda, display=c("lc","cn"), main="Lousiana Intermediatewhater Communities (2007-2016)")
...
#ggsave('2018Intermediatewater_RDA_Plot.jpeg', dpi=300, height=5, width=9)
...
dim(BrackishOnly)#767 441
unique(BrackishOnly$year)#Lack of 2007.
...
dim(BrackishOnly_Cover)#714 441

BrackishVeg_Cover<-BrackishOnly_Cover[,8:437] #Brackishwater veg cover data only
...
BrackishEnv<-BrackishOnly_Cover [ , c(1:7,286, 438:441)] # Env data for Brackishwater Community +"Phraust"
dim(BrackishEnv)#714  12, colum 286 = "Phraaust"
...
##############Df  Variance       F Pr(>F)    
#MeanSalinity   1 0.000396 8.6377  0.001 ***
#Phraaust       1 0.000260 5.6702  0.003 ** 
...
ggsave('2018Brackishwater_RDA_Plot.jpeg', dpi=300, height=5, width=9)
...
dim(SalineOnly_Cover)#546 441

SalineVeg_Cover<-SalineOnly_Cover[,8:437] #Salinewater veg cover data only
...
SalineEnv<-SalineOnly_Cover [ , c(1:7,286, 438:441)] # Env data for Salinewater Community +"Phraust"
dim(SalineEnv)#546  12, colum 286 = "Phraaust"
...
#Phraaust       1 0.000144  1.8844  0.139    
...
ggsave('2018Saline_RDA_Plot.jpeg', dpi=300, height=5, width=9)
